...
/* cardano-c: upstream pulled memzero() from trezor-firmware/crypto/memzero.h.
 * Vendor it locally as a memset-based shim to keep this a self-contained pair
 * of files. No algorithm or copyright text was changed. */
