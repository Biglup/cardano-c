...
/**
 * \brief Serializes a list of Plutus v2 scripts to CIP-116 JSON.
 *
 * Writes a JSON array where each element is a Plutus v2 script object with the shape:
 *
 * \code{.json}
 * [
 *   { "language": "plutus_v2", "bytes": "<hex-bytes>" },
 *   { "language": "plutus_v2", "bytes": "<hex-bytes>" }
 * ]
 * \endcode
 *
 ...
 *
 * \param[in] plutus_v2_scripts A valid pointer to a list of Plutus v2 scripts.
 ...
 *         - \ref CARDANO_ERROR_POINTER_IS_NULL if \p plutus_v2_scripts or \p writer is NULL.
