...
/**
 * \brief Serializes a list of transaction outputs to a CIP-116 JSON array.
 *
 * This function iterates over the list and serializes each \ref cardano_transaction_output_t
 * into a JSON array.
 *
 * \param[in]  list    Pointer to a valid \ref cardano_transaction_output_list_t.
 ...
 */
CARDANO_NODISCARD
CARDANO_EXPORT cardano_error_t cardano_transaction_output_list_to_cip116_json(
  const cardano_transaction_output_list_t* list,
