...
/**
 * \brief Serializes a set of transaction inputs to a CIP-116 JSON array.
 *
 * This function iterates over the set and serializes each \ref cardano_transaction_input_t
 * into a JSON array.
 *
 * \param[in]  set     Pointer to a valid \ref cardano_transaction_input_set_t.
 ...
 */
CARDANO_NODISCARD
CARDANO_EXPORT cardano_error_t cardano_transaction_input_set_to_cip116_json(
