 ...
 * converting between Unix slot_config and slots in the Cardano network. This structure
...
typedef struct cardano_slot_config_t
{
    ...
    /**
     * \brief The initial slot number corresponding to `zero_slot_config`. It is the reference slot number that
     * maps directly to `zero_slot_config`, allowing accurate calculation of other slot numbers relative to
     * this baseline.
     */
    uint64_t zero_slot;
