...
/**
 * \brief Serializes DRep voting thresholds to CIP-116 JSON.
 *
 * The function writes the full JSON object, including the surrounding braces.
 *
 * \param[in]  thresholds  Pointer to a valid \ref cardano_drep_voting_thresholds_t.
 * \param[in]  writer      Pointer to a valid \ref cardano_json_writer_t.
 *
 * \return CARDANO_SUCCESS       On success.
 * CARDANO_ERROR_POINTER_IS_NULL If \p thresholds or \p writer is NULL.
