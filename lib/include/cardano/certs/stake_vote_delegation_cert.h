...
cardano_stake_registration_from_cbor(cardano_cbor_reader_t* reader, cardano_stake_registration_cert_t** stake_registration);
 ...
 * Usage Example:
 * \code{.c}
 * cardano_stake_registration_cert_t* stake_registration = cardano_stake_registration_new(major, minor);
 *
 ...
 * \endcode
 *
 * \note After calling \ref cardano_stake_registration_unref, the pointer to the \ref cardano_stake_registration_cert_t object
 *       will be set to NULL to prevent its reuse.
 */
CARDANO_EXPORT void cardano_stake_registration_unref(cardano_stake_registration_cert_t** stake_registration);
 ...
 */
CARDANO_EXPORT void cardano_stake_registration_ref(cardano_stake_registration_cert_t* stake_registration);
 ...
 */
CARDANO_NODISCARD
CARDANO_EXPORT size_t cardano_stake_registration_refcount(const cardano_stake_registration_cert_t* stake_registration);
