...
cardano_auth_committee_hot_from_cbor(cardano_cbor_reader_t* reader, cardano_auth_committee_hot_cert_t** auth_committee_hot);
 ...
 * Usage Example:
 * \code{.c}
 * cardano_auth_committee_hot_cert_t* auth_committee_hot = cardano_auth_committee_hot_new(major, minor);
 *
 ...
 * \endcode
 *
 * \note After calling \ref cardano_auth_committee_hot_unref, the pointer to the \ref cardano_auth_committee_hot_cert_t object
 *       will be set to NULL to prevent its reuse.
 */
CARDANO_EXPORT void cardano_auth_committee_hot_unref(cardano_auth_committee_hot_cert_t** auth_committee_hot);
 ...
 */
CARDANO_EXPORT void cardano_auth_committee_hot_ref(cardano_auth_committee_hot_cert_t* auth_committee_hot);
 ...
 */
CARDANO_NODISCARD
CARDANO_EXPORT size_t cardano_auth_committee_hot_refcount(const cardano_auth_committee_hot_cert_t* auth_committee_hot);
