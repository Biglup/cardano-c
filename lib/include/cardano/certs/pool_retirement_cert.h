...
/**
 * \brief Serializes a pool retirement certificate to CIP-116 JSON.
 *
 * The function writes the full JSON object, including the surrounding braces.
 * Keys are written in the order: "tag", "pool_keyhash", "epoch".
 *
 * \param[in]  cert    Pointer to a valid \ref cardano_pool_retirement_cert_t.
