 ...
 */
typedef struct cardano_auth_committee_hot_t cardano_auth_committee_hot_t;

/**
 * \brief Creates a \ref cardano_auth_committee_hot_t from a CBOR reader.
 *
 * This function parses CBOR data using a provided \ref cardano_cbor_reader_t and constructs a \ref cardano_auth_committee_hot_t object.
 ...
 * \param[out] auth_committee_hot A pointer to a pointer of \ref cardano_auth_committee_hot_t that will be set to the address
 ...
 *       The caller is responsible for freeing the created \ref cardano_auth_committee_hot_t object by calling
 *       \ref cardano_auth_committee_hot_unref when it is no longer needed.
 *
 * Usage Example:
 * \code{.c}
 * cardano_cbor_reader_t* reader = cardano_cbor_reader_new(cbor_data, data_size);
 * cardano_auth_committee_hot_t* auth_committee_hot = NULL;
 *
...
cardano_auth_committee_hot_from_cbor(cardano_cbor_reader_t* reader, cardano_auth_committee_hot_t** auth_committee_hot);

/**
 * \brief Serializes protocol version into CBOR format using a CBOR writer.
 *
 * This function serializes the given \ref cardano_auth_committee_hot_t object using a \ref cardano_cbor_writer_t.
 *
 * \param[in] auth_committee_hot A constant pointer to the \ref cardano_auth_committee_hot_t object that is to be serialized.
 ...
 * Usage Example:
 * \code{.c}
 * cardano_auth_committee_hot_t* auth_committee_hot = ...;
 * cardano_cbor_writer_t* writer = cardano_cbor_writer_new();
 *
 * if (writer)
 * {
 *   cardano_error_t result = cardano_auth_committee_hot_to_cbor(auth_committee_hot, writer);
 *
 *   if (result == CARDANO_SUCCESS)
 *   {
 ...
 */
CARDANO_NODISCARD
CARDANO_EXPORT cardano_error_t cardano_auth_committee_hot_to_cbor(
  const cardano_auth_committee_hot_t* auth_committee_hot,
  cardano_cbor_writer_t*              writer);

/**
 * \brief Decrements the reference count of a cardano_auth_committee_hot_t object.
 *
 * This function is responsible for managing the lifecycle of a \ref cardano_auth_committee_hot_t object
 ...
 * Usage Example:
 * \code{.c}
 * cardano_auth_committee_hot_t* auth_committee_hot = cardano_auth_committee_hot_new(major, minor);
 *
 ...
 * \endcode
 *
 * \note After calling \ref cardano_auth_committee_hot_unref, the pointer to the \ref cardano_auth_committee_hot_t object
 *       will be set to NULL to prevent its reuse.
 */
CARDANO_EXPORT void cardano_auth_committee_hot_unref(cardano_auth_committee_hot_t** auth_committee_hot);

/**
 * \brief Increases the reference count of the cardano_auth_committee_hot_t object.
 *
 * This function is used to manually increment the reference count of an cardano_auth_committee_hot_t
 * object, indicating that another part of the code has taken ownership of it. This
 * ensures the object remains allocated and valid until all owners have released their
 * reference by calling \ref cardano_auth_committee_hot_unref.
 *
 * \param auth_committee_hot A pointer to the cardano_auth_committee_hot_t object whose reference count is to be incremented.
 *
 * Usage Example:
 * \code{.c}
 ...
 */
CARDANO_EXPORT void cardano_auth_committee_hot_ref(cardano_auth_committee_hot_t* auth_committee_hot);

/**
 * \brief Retrieves the current reference count of the cardano_auth_committee_hot_t object.
 *
 * This function returns the number of active references to an cardano_auth_committee_hot_t object. It's useful
 * for debugging purposes or managing the lifecycle of the object in complex scenarios.
 *
 * \warning This function does not account for transitive references. A transitive reference
 * occurs when an object holds a reference to another object, rather than directly to the
 * cardano_auth_committee_hot_t. As such, the reported count may not fully represent the total number
 * of conceptual references in cases where such transitive relationships exist.
 *
 * \param auth_committee_hot A pointer to the cardano_auth_committee_hot_t object whose reference count is queried.
 *                    The object must not be NULL.
 *
 * \return The number of active references to the specified cardano_auth_committee_hot_t object. If the object
 ...
 */
CARDANO_NODISCARD
CARDANO_EXPORT size_t cardano_auth_committee_hot_refcount(const cardano_auth_committee_hot_t* auth_committee_hot);

/**
 * \brief Sets the last error message for a given cardano_auth_committee_hot_t object.
 *
 ...
 *
 * \param[in] auth_committee_hot A pointer to the \ref cardano_auth_committee_hot_t instance whose last error message is
 ...
 *
 * \param[in] auth_committee_hot A pointer to the \ref cardano_auth_committee_hot_t instance whose last error
