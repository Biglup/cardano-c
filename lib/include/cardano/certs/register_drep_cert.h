...
/**
 * \brief Serializes a register DRep certificate to CIP-116 JSON.
 *
 * The function writes the full JSON object, including the surrounding braces.
 * Keys are written in the order: "tag", "drep_credential", "coin", "anchor".
 *
 * \param[in]  cert    Pointer to a valid \ref cardano_register_drep_cert_t.
...
CARDANO_NODISCARD
CARDANO_EXPORT cardano_error_t
cardano_register_drep_cert_to_cip116_json(
