 ...
 * \param[out] auth_committee_hot A pointer to a pointer of \ref cardano_pool_retirement_cert_t that will be set to the address
 ...
 * cardano_pool_retirement_cert_t* auth_committee_hot = NULL;
 *
...
cardano_auth_committee_hot_from_cbor(cardano_cbor_reader_t* reader, cardano_pool_retirement_cert_t** auth_committee_hot);
 ...
 *
 * \param[in] auth_committee_hot A constant pointer to the \ref cardano_pool_retirement_cert_t object that is to be serialized.
 ...
 * Usage Example:
 * \code{.c}
 * cardano_pool_retirement_cert_t* auth_committee_hot = ...;
 * cardano_cbor_writer_t* writer = cardano_cbor_writer_new();
 *
 * if (writer)
 * {
 *   cardano_error_t result = cardano_pool_retirement_cert_to_cbor(auth_committee_hot, writer);
 *
 *   if (result == CARDANO_SUCCESS)
 *   {
...
CARDANO_EXPORT cardano_error_t cardano_pool_retirement_cert_to_cbor(
  const cardano_pool_retirement_cert_t* auth_committee_hot,
 ...
 * Usage Example:
 * \code{.c}
 * cardano_pool_retirement_cert_t* auth_committee_hot = cardano_auth_committee_hot_new(major, minor);
 *
 ...
 * \endcode
 *
 * \note After calling \ref cardano_auth_committee_hot_unref, the pointer to the \ref cardano_pool_retirement_cert_t object
 *       will be set to NULL to prevent its reuse.
 */
CARDANO_EXPORT void cardano_auth_committee_hot_unref(cardano_pool_retirement_cert_t** auth_committee_hot);
 ...
 *
 * \param auth_committee_hot A pointer to the cardano_pool_retirement_cert_t object whose reference count is to be incremented.
 *
 * Usage Example:
 * \code{.c}
 ...
 */
CARDANO_EXPORT void cardano_auth_committee_hot_ref(cardano_pool_retirement_cert_t* auth_committee_hot);
 ...
 *
 * \param auth_committee_hot A pointer to the cardano_pool_retirement_cert_t object whose reference count is queried.
 ...
 */
CARDANO_NODISCARD
CARDANO_EXPORT size_t cardano_auth_committee_hot_refcount(const cardano_pool_retirement_cert_t* auth_committee_hot);
 ...
 *
 * \param[in] auth_committee_hot A pointer to the \ref cardano_pool_retirement_cert_t instance whose last error message is
 ...
 *
 * \param[in] auth_committee_hot A pointer to the \ref cardano_pool_retirement_cert_t instance whose last error
