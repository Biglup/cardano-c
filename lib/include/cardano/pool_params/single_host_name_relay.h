...
/**
 * \brief Serializes a single host name relay to CIP-116 JSON.
 *
 * The function writes the full JSON object, including the surrounding braces.
 * Keys are written in the order: "tag", "port", "dns_name".
 *
 * \param[in]  relay   Pointer to a valid \ref cardano_single_host_name_relay_t.
