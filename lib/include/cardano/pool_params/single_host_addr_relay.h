...
/**
 * \brief Serializes a single host address relay to CIP-116 JSON.
 *
 * The function writes the full JSON object, including the surrounding braces.
 * Keys are written in the order: "tag", "port", "ipv4", "ipv6".
 *
 * \param[in]  relay   Pointer to a valid \ref cardano_single_host_addr_relay_t.
