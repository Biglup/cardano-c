...
/**
 * \brief Serializes a set of VKey witnesses to a CIP-116 JSON array.
 *
 * This function iterates over the set and serializes each \ref cardano_vkey_witness_t
 * into a JSON array.
 *
 * \param[in]  witnesses Pointer to a valid \ref cardano_vkey_witness_set_t.
 ...
 */
CARDANO_NODISCARD
CARDANO_EXPORT cardano_error_t cardano_vkey_witness_set_to_cip116_json(
