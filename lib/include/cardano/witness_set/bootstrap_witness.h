...
#ifndef CARDANO_BOOTSTRAP_WITNESS_H
#define CARDANO_BOOTSTRAP_WITNESS_H
 ...
 *         was successfully set. Returns \ref CARDANO_POINTER_IS_NULL if either \p bootstrap_witness or \p signature is NULL.
 *
 ...
 *         was successfully set, or an appropriate error code if an error occurred, such as \ref CARDANO_POINTER_IS_NULL
...
#endif // CARDANO_BOOTSTRAP_WITNESS_H