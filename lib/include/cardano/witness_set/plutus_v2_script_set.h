...
/**
 * \brief Serializes a set of Plutus v2 scripts to CIP-116 JSON.
 *
 ...
 * \code{.json}
 * [
 *   {"language":"plutus_v2","bytes":"0001"},
 *   {"language":"plutus_v2","bytes":"aabbcc"}
 * ]
 * \endcode
 *
 ...
 * as that value.
 *
 * \param[in] plutus_v2_scripts  A valid pointer to a Plutus v2 script set.
