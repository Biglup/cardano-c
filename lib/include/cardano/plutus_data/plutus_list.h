...
/**
 * \brief Serializes a Plutus list to a CIP-116 JSON array.
 *
 * This function recursively serializes the elements of the Plutus list as a JSON array.
 * Each element in the list is serialized as a PlutusData object.
 *
 * \param[in]  list    Pointer to a valid \ref cardano_plutus_list_t.
 ...
 */
CARDANO_NODISCARD
CARDANO_EXPORT cardano_error_t cardano_plutus_list_to_cip116_json(
