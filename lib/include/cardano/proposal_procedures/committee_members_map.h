...
/**
 * \brief Serializes a committee members map to a CIP-116 JSON array.
 *
 * This function serializes a map of [Credential -> Epoch] into
 * a JSON array of key-value objects:
 * [ { "key": { ...Credential... }, "value": "<uint64_string>" }, ... ]
 *
 * \param[in]  map     Pointer to a valid \ref cardano_committee_members_map_t.
