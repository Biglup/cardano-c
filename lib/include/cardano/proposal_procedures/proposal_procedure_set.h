...
/**
 * \brief Serializes a set of proposal procedures to a CIP-116 JSON array.
 *
 * This function iterates over the set and serializes each \ref cardano_proposal_procedure_t
 * into a JSON array.
 *
 * \param[in]  procedures Pointer to a valid \ref cardano_proposal_procedure_set_t.
 ...
 */
CARDANO_NODISCARD
CARDANO_EXPORT cardano_error_t cardano_proposal_procedure_set_to_cip116_json(
