...
static const char* COSTMDLS_V4_CBOR           = "";
...
TEST(cardano_costmdls_to_cbor, canRoundTripCostmdlsWithPlutusV4)
{
  // Arrange
  cardano_costmdls_t*    costmdls = nullptr;
  cardano_cbor_reader_t* reader   = cardano_cbor_reader_from_hex(COSTMDLS_V4_CBOR, strlen(COSTMDLS_V4_CBOR));
  cardano_cbor_writer_t* writer   = cardano_cbor_writer_new();

  cardano_error_t error = cardano_costmdls_from_cbor(reader, &costmdls);

  ASSERT_EQ(error, CARDANO_SUCCESS);
  EXPECT_EQ(cardano_costmdls_has(costmdls, CARDANO_PLUTUS_LANGUAGE_VERSION_V4), true);
  ...
  EXPECT_STREQ(cbor_hex, COSTMDLS_V4_CBOR);
...
TEST(cardano_costmdls_get, canGetCostModelV4)
{
  // Arrange
  cardano_costmdls_t*    costmdls      = nullptr;
  cardano_cost_model_t*  cost_model_v4 = nullptr;
  cardano_cbor_reader_t* reader        = cardano_cbor_reader_from_hex(COST_MODE_V4_CBOR_HEX, strlen(COST_MODE_V4_CBOR_HEX));

  cardano_error_t error = cardano_costmdls_new(&costmdls);

  ASSERT_EQ(error, CARDANO_SUCCESS);

  error = cardano_cost_model_from_cbor(reader, &cost_model_v4);

  ASSERT_EQ(error, CARDANO_SUCCESS);

  error = cardano_costmdls_insert(costmdls, cost_model_v4);
  ...
  ASSERT_EQ(cardano_costmdls_get(costmdls, CARDANO_PLUTUS_LANGUAGE_VERSION_V4, &model), CARDANO_SUCCESS);
  ...
  cardano_costmdls_unref(&costmdls);
  cardano_cost_model_unref(&model);
  cardano_cost_model_unref(&cost_model_v4);
  cardano_cbor_reader_unref(&reader);
}
...
TEST(cardano_costmdls_has, returnsTrueIfPlutusV4ModelExists)
{
  // Arrange
  cardano_costmdls_t*    costmdls      = nullptr;
  cardano_cost_model_t*  cost_model_v4 = nullptr;
  ...
  // Act
  bool has = cardano_costmdls_has(costmdls, CARDANO_PLUTUS_LANGUAGE_VERSION_V4);
...
// Post protocol version 11 (van Rossem) the PlutusV1 cost model on mainnet has 332
// entries; every entry must land in the language views (and thus the script data
// hash), not just the original 166. Expected bytes generated independently from
// the enacted mainnet parameters following the Alonzo language views encoding.
TEST(cardano_costmdls_get_language_views_encoding, encodesEveryV1EntryPostVanRossem)
{
  // Arrange
  static const int64_t V1_VAN_ROSSEM_COSTS[] = {
    100788,
    420,
    1,
    1,
  ...
  const size_t costs_size = sizeof(V1_VAN_ROSSEM_COSTS) / sizeof(V1_VAN_ROSSEM_COSTS[0]);

  EXPECT_EQ(costs_size, 332U);
  ...
  error = cardano_cost_model_new(CARDANO_PLUTUS_LANGUAGE_VERSION_V1, V1_VAN_ROSSEM_COSTS, costs_size, &cost_model_v1);
  ...
  // Assert
  EXPECT_STREQ(language_view, "");
...
TEST(cardano_costmdls_get_language_views_encoding, canComputeLanguageViewsWithPlutusV4)
{
  // Arrange
  cardano_costmdls_t*    costmdls      = nullptr;
  cardano_cost_model_t*  cost_model_v3 = nullptr;
  cardano_cost_model_t*  cost_model_v4 = nullptr;
  cardano_cbor_reader_t* reader_v3     = cardano_cbor_reader_from_hex(COST_MODE_V3_CBOR_HEX, strlen(COST_MODE_V3_CBOR_HEX));
  cardano_cbor_reader_t* reader_v4     = cardano_cbor_reader_from_hex(COST_MODE_V4_CBOR_HEX, strlen(COST_MODE_V4_CBOR_HEX));
  ...
  error = cardano_cost_model_from_cbor(reader_v4, &cost_model_v4);
  ...
  // Assert
  const std::string expected = std::string("a2") + COST_MODE_V3_CBOR_HEX + COST_MODE_V4_CBOR_HEX;
  EXPECT_STREQ(language_view, expected.c_str());

  // Cleanup
  cardano_costmdls_unref(&costmdls);
  cardano_cbor_reader_unref(&reader_v3);
  cardano_cbor_reader_unref(&reader_v4);
  cardano_cost_model_unref(&cost_model_v3);
  cardano_cost_model_unref(&cost_model_v4);
  free(language_view);
  cardano_buffer_unref(&views);
