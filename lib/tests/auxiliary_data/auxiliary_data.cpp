...
static const char* PLUTUS_V4_LIST_CBOR               = "844e4d010000332222200512001200114e4d010001332222200512001200114e4d010002332222200512001200114e4d01000333222220051200120011";
static const char* AUXILIARY_DATA_WITH_V4_CBOR       = "";
...
TEST(cardano_auxiliary_data_to_cbor, canSerializeWithPlutusV4Scripts)
{
  // Arrange
  cardano_cbor_writer_t*    writer         = cardano_cbor_writer_new();
  cardano_auxiliary_data_t* auxiliary_data = new_default_auxiliary_data(AUXILIARY_DATA_WITH_V4_CBOR);
  EXPECT_NE(auxiliary_data, nullptr);
  ...
  EXPECT_STREQ(hex, AUXILIARY_DATA_WITH_V4_CBOR);
...
TEST(cardano_auxiliary_data_from_cbor, returnsErrorIfInvalidPlutusV4Alonzo)
{
  // Arrange
  cardano_auxiliary_data_t* auxiliary_data = NULL;
  const char*               cbor           = "";
  cardano_cbor_reader_t*    reader         = cardano_cbor_reader_from_hex(cbor, strlen(cbor));
...
TEST(cardano_auxiliary_data_get_plutus_v4_scripts, returnsErrorIfObjectIsNull)
{
  // Act
  cardano_plutus_v4_script_list_t* plutus_data = cardano_auxiliary_data_get_plutus_v4_scripts(nullptr);

  // Assert
  EXPECT_EQ(plutus_data, nullptr);
}

TEST(cardano_auxiliary_data_get_plutus_v4_scripts, returnsNullIfScriptsAreNotPresent)
{
  // Arrange
  cardano_auxiliary_data_t* auxiliary_data = new_default_auxiliary_data(AUXILIARY_DATA_WITH_V4_CBOR);

  EXPECT_EQ(cardano_auxiliary_data_set_plutus_v4_scripts(auxiliary_data, nullptr), CARDANO_SUCCESS);

  // Act
  cardano_plutus_v4_script_list_t* plutus_data = cardano_auxiliary_data_get_plutus_v4_scripts(auxiliary_data);
  ...
  // Cleanup
  cardano_auxiliary_data_unref(&auxiliary_data);
  cardano_plutus_v4_script_list_unref(&plutus_data);
}

TEST(cardano_auxiliary_data_get_plutus_v4_scripts, returnsScriptsIfPresent)
{
  // Arrange
  cardano_auxiliary_data_t* auxiliary_data = new_default_auxiliary_data(AUXILIARY_DATA_WITH_V4_CBOR);
...
TEST(cardano_auxiliary_data_set_plutus_v4_scripts, returnsErrorIfObjectIsNull)
{
  // Act
  cardano_error_t result = cardano_auxiliary_data_set_plutus_v4_scripts(nullptr, nullptr);

  // Assert
  EXPECT_EQ(result, CARDANO_ERROR_POINTER_IS_NULL);
}

TEST(cardano_auxiliary_data_set_plutus_v4_scripts, canSetScriptsToNull)
{
  // Arrange
  cardano_auxiliary_data_t* auxiliary_data = new_default_auxiliary_data(AUXILIARY_DATA_WITH_V4_CBOR);

  // Act
  cardano_error_t result = cardano_auxiliary_data_set_plutus_v4_scripts(auxiliary_data, nullptr);
...
TEST(cardano_auxiliary_data_set_plutus_v4_scripts, canSetScripts)
{
  // Arrange
  cardano_auxiliary_data_t*        auxiliary_data = new_default_auxiliary_data(AUXILIARY_DATA_WITH_V4_CBOR);
  cardano_plutus_v4_script_list_t* plutus_data    = NULL;
  cardano_cbor_reader_t*           cbor_reader    = cardano_cbor_reader_from_hex(PLUTUS_V4_LIST_CBOR, strlen(PLUTUS_V4_LIST_CBOR));

  cardano_error_t result = cardano_plutus_v4_script_list_from_cbor(cbor_reader, &plutus_data);

  EXPECT_THAT(result, CARDANO_SUCCESS);

  // Act
  result = cardano_auxiliary_data_set_plutus_v4_scripts(auxiliary_data, plutus_data);

  // Assert
  EXPECT_EQ(result, CARDANO_SUCCESS);

  cardano_plutus_v4_script_list_t* plutus_data3 = cardano_auxiliary_data_get_plutus_v4_scripts(auxiliary_data);
  ...
  cardano_auxiliary_data_unref(&auxiliary_data);
  cardano_plutus_v4_script_list_unref(&plutus_data);
  cardano_plutus_v4_script_list_unref(&plutus_data3);
  cardano_cbor_reader_unref(&cbor_reader);
}
