...
TEST(cardano_registration_cert_to_cip116_json, canConvertToCip116Json)
{
  // Arrange
  cardano_registration_cert_t* cert = new_default_cert();
  ...
  // Act
  cardano_error_t error    = cardano_registration_cert_to_cip116_json(cert, json);
...
TEST(cardano_registration_cert_to_cip116_json, returnsErrorIfCertIsNull)
{
  // Arrange
  cardano_json_writer_t* json = cardano_json_writer_new(CARDANO_JSON_FORMAT_COMPACT);

  // Act
  cardano_error_t error = cardano_registration_cert_to_cip116_json(nullptr, json);
...
TEST(cardano_registration_cert_to_cip116_json, returnsErrorIfWriterIsNull)
{
  // Arrange
  cardano_registration_cert_t* cert = new_default_cert();

  // Act
  cardano_error_t error = cardano_registration_cert_to_cip116_json(cert, nullptr);
