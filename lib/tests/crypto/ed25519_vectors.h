...
// Test vectors taken from https://www.rfc-editor.org/rfc/rfc8032#page-23

typedef struct cardano_ed25519_test_vector_t
{
    const char* secret_key;
    const char* public_key;
    const char* message;
    const char* signature;
} cardano_ed25519_test_vector_t;

static const cardano_ed25519_test_vector_t cardano_ed25519_test_vectors[] = {
...
#endif /* CARDANO_ED25519_VECTORS_H */
