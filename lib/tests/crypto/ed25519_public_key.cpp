...
TEST(cardano_ed25519_public_key_get_data, returnsNullIfGivenANullPtr)
{
  // Act
  const byte_t* data = cardano_ed25519_public_key_get_data(nullptr);

  // Assert
  EXPECT_EQ(data, (const byte_t*)nullptr);
}

TEST(cardano_ed25519_public_key_get_bytes_size, returnsZeroIfGivenANullPtr)
{
  // Act
  size_t size = cardano_ed25519_public_key_get_bytes_size(nullptr);

  // Assert
  EXPECT_EQ(size, 0);
}

TEST(cardano_ed25519_public_key_get_hex_size, returnsZeroIfGivenANullPtr)
{
  // Act
  size_t size = cardano_ed25519_public_key_get_hex_size(nullptr);

  // Assert
  EXPECT_EQ(size, 0);
}

TEST(cardano_ed25519_public_key_to_hex, returnsErrorIfBufferIsNull)
{
  // Arrange
  cardano_ed25519_public_key_t* public_key = nullptr;

  // Act
  cardano_error_t error = cardano_ed25519_public_key_to_hex(public_key, nullptr, 0);

  // Assert
  EXPECT_EQ(error, CARDANO_ERROR_POINTER_IS_NULL);
}

TEST(cardano_ed25519_public_key_to_hash, returnsErrorIfPublicKeyIsNull)
{
  // Arrange
  cardano_ed25519_public_key_t* public_key = nullptr;
  ...
  // Act
  cardano_error_t error = cardano_ed25519_public_key_to_hash(public_key, &hash);
...
TEST(cardano_ed25519_public_key_to_hash, returnsErrorIfHashIsNull)
{
  // Arrange
  cardano_ed25519_public_key_t* public_key = nullptr;
  cardano_error_t               error      = cardano_ed25519_public_key_from_hex(PUBLIC_KEY_HEX, PUBLIC_KEY_SIZE * 2, &public_key);
  ...
  // Act
  cardano_error_t hash_error = cardano_ed25519_public_key_to_hash(public_key, nullptr);
...
TEST(cardano_ed25519_public_key_to_hash, canComputeTheHash)
{
  // Arrange
  cardano_ed25519_public_key_t* public_key = nullptr;
  cardano_error_t               error      = cardano_ed25519_public_key_from_hex(PUBLIC_KEY_HEX, PUBLIC_KEY_SIZE * 2, &public_key);
  ...
  // Act
  cardano_error_t hash_error = cardano_ed25519_public_key_to_hash(public_key, &hash);
