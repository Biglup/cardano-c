 ...
 *
 * Priority tiers (port of the reference implementation's SelectSingleton / SelectPairWith /
 * SelectAnyWith filters): UTXOs whose total asset count (lovelace included) is 1, then 2, then
 * any. A NULL asset id selects by lovelace.
 *
