  ...
  cardano_cbor_writer_t*                       writer)
{
  ...
  cardano_error_t write_enum_result = cardano_cbor_writer_write_unsigned_int(writer, CARDANO_GOVERNANCE_ACTION_TYPE_HARD_FORK_INITIATION);
  ...
  if (protocol_version_result != CARDANO_SUCCESS)
  {
    return protocol_version_result; // LCOV_EXCL_LINE
  }
