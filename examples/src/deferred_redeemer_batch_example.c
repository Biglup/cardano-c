...
main(void)
{
  ...
  console_info("This example will spend two UTxOs from a plutus script in a single transaction, pairing each input with its payout output via deferred redeemers.");
