...
VERSION="-DVERSION_MAJOR=${VERSION_MAJOR} -DVERSION_MINOR=${VERSION_MINOR} -DVERSION_PATCH=${VERSION_REVISION}"

CMAKE_OPTIONS="${CMAKE_USER_OPTIONS} -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=/usr -DDOXYGEN_ENABLED:BOOL=ON"
